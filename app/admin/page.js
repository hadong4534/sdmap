      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        {tab === "cs" && (
          <section className="py-6 space-y-3">
            {inquiries.map((c) => (
              <div key={c.id} className="rounded-[20px] bg-white shadow-[0_4px_16px_rgba(37,34,54,0.06)] p-4">
        ...
        {tab === "staff" && (
          <section className="py-6 space-y-4">
            ...
            <div className="rounded-[20px] bg-white shadow-[0_4px_16px_rgba(37,34,54,0.06)] overflow-x-auto">
        ...
        {tab === "apps" && (
          <section className="py-6 rounded-[20px] bg-white shadow-[0_4px_16px_rgba(37,34,54,0.06)] overflow-hidden mt-0">
            <table className="w-full text-sm">
