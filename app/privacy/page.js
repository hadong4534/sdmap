...
export default function Privacy() {
  return (
    <main className="min-h-screen bg-surface pb-16">
      <header className="bg-white border-b border-line"><div className="max-w-2xl mx-auto px-5 py-4 flex items-center gap-3"><Link href="/login" className="text-xl text-muted">‹</Link><b className="text-lg">개인정보처리방침</b></div></header>
