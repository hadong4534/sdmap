  ...
  return (
    <main className="min-h-[100dvh] bg-aurora">
      ...
      <div className="max-w-xl mx-auto px-5 py-6">
        {done ? (
          <div className="rounded-[20px] bg-white shadow-[0_4px_16px_rgba(37,34,54,0.06)] p-8 text-center">
          ...
          <div className="rounded-[20px] bg-white shadow-[0_4px_16px_rgba(37,34,54,0.06)] p-5 space-y-3">
